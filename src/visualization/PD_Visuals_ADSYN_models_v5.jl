...
data = JLD2.load("../../outputs/models/results_ADASYN_20260503_161124.jld2")
...
begin
    _inner_fold_csv = "../../outputs/metrics/inner_fold_metrics_ADASYN_20260503_163355.csv"
...
begin
	...
	paths = Dict(
	    :baseline        =>
			"../../outputs/metrics/results_baseline_(ADASYN)_20260503_161124.csv",
	    :sex_aware       => "../../outputs/metrics/results_sex aware_(ADASYN)_20260503_161124.csv",
	    :male            => "../../outputs/metrics/results_male_(ADASYN)_20260503_161124.csv",
	    :female          => "../../outputs/metrics/results_female_(ADASYN)_20260503_161124.csv",
	    :baseline_male   => "../../outputs/metrics/results_baseline_male_(ADASYN)_20260503_161124.csv",
	    :baseline_female => "../../outputs/metrics/results_baseline_female_(ADASYN)_20260503_161124.csv",
	)
    ...
    if inner_fold_df === nothing
        ...
        best_configs_t2 = Dict(
            ...
            "baseline_female" => (method="Boruta", n_features=100,
								  classifier="NeuralNetwork"),
            "sex aware"       => (method="mRMR",   n_features=80,
