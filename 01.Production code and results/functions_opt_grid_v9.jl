...
function export_baseline_sex_stratified(
    ...
    male_filename = "results_baseline_male_($strategy)_$date.csv"
    female_filename = "results_baseline_female_($strategy)_$date.csv"
...
function export_baseline_sex_stratified_shap(
    ...
    date = Dates.format(now(), "yyyymmdd_HHMMSS")
    filename = "shap_baseline_sex_stratified_$(strategy)_$date.csv"
...
# ============================================================================
function export_all_results_to_csv(all_results::Dict, top_n_feats_candidates::Vector{Int}, strategy::String)
    ...
    for (dataset_name, nested_cv_results) in all_results
        ...
        # Save to CSV
		date= (Dates.format(now(), "yyyymmdd_HHMMSS"))
        filename = "results_$(dataset_name)_($strategy)_$date.csv"
