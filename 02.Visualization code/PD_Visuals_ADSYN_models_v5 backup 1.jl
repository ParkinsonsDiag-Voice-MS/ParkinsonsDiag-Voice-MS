...
begin
    _inner_fold_csv = "../01.Production code and results/inner_fold_metrics_ADASYN_20260430_140813.csv"
...
LocalResource("Figure1_Workflow_diagram_simple.jpg")
...
savefig(p_fig2a, "Figure2a_bar_chart_best_perf_models.png") # just for local 
savefig(p_fig2a, "Figure2a_bar_chart_best_perf_models.pdf") # for ms submission
...
"""
	...
	savefig(p_fig2b, "Figure2b_jaccard_index_by_nfeatures.png") # just for local 
	savefig(p_fig2b, "Figure2b_jaccard_index_by_nfeatures.pdf") # for ms submission
end;
...
savefig(p_fig3, "Figure3_Top_3_Classifier-Method_Combo.png") # just for local 
savefig(p_fig3, "Figure3_Top_3_Classifier-Method_Combo.pdf") # for ms submission
...
begin
cm_csv_path = "Best_models_confusion_matrices_table.csv"
...
Image file generation
"""
    CairoMakie.save("Figure4_Confusion_Matrices.png", 
					fig4; px_per_unit=2, 
					backgroundcolor=:white) 			# for local 
    CairoMakie.save("Figure4_Confusion_Matrices.pdf", 
					fig4; 
...
begin
	...
	# Load icons
	union_icon_b64 = base64encode(read("union_symbol.png"))
	male_icon_b64 = base64encode(read("male_symbol.png"))
    female_icon_b64 = base64encode(read("female_symbol.png"))
	
	# Load SHAP data
    male_shap = CSV.read("male_shap.csv", DataFrame)
    female_shap = CSV.read("female_shap.csv", DataFrame)
...
begin
	...
	male_shap_df   = CSV.read("male_shap_mrmr_20.csv", DataFrame)
	female_shap_df = CSV.read("female_shap_mrmr_10.csv", DataFrame)
